...
|---------------------|----------------------|-----|----------|
| Softening           | Softening            | 0   | 19,283   |
| Softening           | Quasi-steady state   | 1   | 12,429   |
| Softening           | Monotonic hardening  | 2   | 36,623   |
| Quasi-steady state  | Quasi-steady state   | 3   |  5,733   |
| Quasi-steady state  | Monotonic hardening  | 4   |  6,922   |
| Monotonic hardening | Monotonic hardening  | 5   | 19,010   |


**`eps*` represents normalized axial strain! Let `eps* := epsilon_a * Ir * (p0)^(n_e - 1)`**
